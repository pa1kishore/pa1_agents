...
```bash
 uv export --no-hashes --no-sources --no-header --no-dev --no-emit-project --no-annotate --locked > app/app_utils/.requirements.txt
          uv run python -m app.app_utils.deploy \
            --project lexical-helix-462005-m6 \
            --location us-central1 \
            --source-packages=./app \
            --entrypoint-module=app.agent_engine_app \
            --entrypoint-object=agent_engine \
            --requirements-file=app/app_utils/.requirements.txt \
            --service-account=adk-service-account@lexical-helix-462005-m6.iam.gserviceaccount.com \
            --set-env-vars="tag=deploying from script"
```

gcloud auth activate-service-account --key-file=/Users/pa1/Downloads/lexical-helix-462005-m6-0ea084868b29.json